...
{
    //This is a singleton design pattern, that's what a static instance is (Keywords!)
    public static GameSystem Instance { get; private set; }
    //public static ScriptableInstanceController InstanceController { get; private set; }

    public DifficultyScriptableObject[] DifficultyObjects;

    public SystemScriptableObject systemScriptable;
